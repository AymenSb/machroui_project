            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body all-icons">
                        @can('modifier projet')
                            <a href="#modaldemo9" data-type="{{ $project->project_type }}"
                                data-informations="{{ $project->informations }}" data-name="{{ $project->name }}"
                                data-id="{{ $project->id }}" data-effect="effect-fall" data-toggle="modal"
                        ...
                        @can('projet')
                            <div class="tab">
                                <button class="tablinks" id='defaultOpen'
                                    onclick="openCity(event, 'London')">Détails</button>
                                <button class="tablinks" id='defaultOpen'
                                ...
                                <button class="tablinks" onclick="openCity(event, 'comments')">Commentaires</button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 pr-1">
                                    <div class="form-group">
                                        ...
                                        <span type="text" name="type"
                                            class="form-control">{{ $project->project_type }}<span>
                                    </div>
                                </div>
                        ...
                        <div id="description" class="tabcontent">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 pr-3">
                                    <div class="form-group">
                                        <textarea disabled type="text" name="informations"
                                            class="form-control">{{ $project->informations }}</textarea>
                                    </div>
                                </div>
                                                        ...
                                                        <td>
                                                            @can('modifier projet')
                                                                <button class="btn btn-outline-danger btn-sm"
                                                                    data-toggle="modal" data-file_name="{{ $image }}"
                                            ...
                                            <table id="example1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($comments as $item)
                                                        ...
                                                        <tr>
                                                            <td>{{ $i }}</td>
                                                            <td>{{ $item->UserComment->name }}
                                                                {{ $item->UserComment->surname }}</td>
                                                            <td>{{ $item->UserComment->email }}</td>
                                                            <td>{{ $item->UserComment->phone_number }}</td>
                                                            <td>{{ $item->comment }}</td>
                                                            <td style="align-content: center">
                                                                @if ($item->isShown == 0)
                                                                    <button class="btn btn-outline-success btn-sm"
                                                                        ...
                                                                        data-target="#show" role="button"><i
                                                                ...
                                                                <button class="btn btn-outline-danger btn-sm"
                                                                    data-toggle="modal"
                                                                    data-request_id="{{ $item->id }}"
                                                                    data-target="#delete_request" role="button"><i
                                                                ...
                                                                @elseif(!$item->isShown)
                                                                    <span>
                                                                        <a class="text-warning">
                                                                            ...
                                                                            &nbsp; Commentaire n'est pas afficher
                                                                        </a>
                                                                    </span>
                                                        ...
                                                        <div class="modal fade" id="show" tabindex="-1" role="dialog"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="{{ route('projectComments.update', $item->id) }}"
                                                                        method="post">
                                                                        {{ method_field('patch') }}
                                                                        {{ csrf_field() }}
                                                                        <div class="modal-body">
                                                                            <p class="text-center">
                                                                            <h6 style="color:rgb(67, 196, 74)">voulez-vous
                                                                                vraiment montrer ce commentaire?</h6>
                                                                            </p>
                                                        ...
                                                        <div class="modal fade" id="delete_request" tabindex="-1"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('projectComments.destroy', $item->id) }}"
                                                                        method="POST">
                                                                        {{ method_field('delete') }}
                                                                        {{ csrf_field() }}
                                                                        <div class="modal-body">
                                                                            <p class="text-center">
                                                                            <h6 style="color:red">Voulez-vous vraiment
                                                                                supprimer ce
                                                                                commentaire</h6>
                                                                            </p>
                    ...
                    <form action='{{ route('project.update', $project->id) }}' method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" name="informations" id="informations"
