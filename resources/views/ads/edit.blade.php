            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @can('modifier pub')
                            <a href="#modal1" data-name="{{ $ad->name }}" data-id="{{ $ad->id }}" data-title="{{$ad->title}}" data-sub_title="{{$ad->sub_title}}"
                                data-is_Visible="{{ $ad->is_Visible }}" data-effect="effect-fall" data-toggle="modal"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 pr-1">
                                    <div class="form-group">
                                        ...
                                        <span type="title" name="title" class="form-control">{{ $ad->title }}</span>
                                    </div>
                                </div>
                                <div class="col-md-3 pr-1">
                                    <div class="form-group">
                                        <label>{{ __('Sous-Titre') }}</label>
                                        <span type="sub_title" name="sub_title"
                                            class="form-control">{{ $ad->sub_title }}</span>
                                    </div>
                                </div>
                    ...
                    <form action='{{ route('ads.update', $ad->id) }}' method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="sub_title" id="sub_title" autocomplete="off">
                            </div>
...
@section('js')
    ...
    <script>
        $('#modal1').on('show.bs.modal', function(event) {
            ...
            var sub_title = button.data('sub_title')
            var id = button.data('id')
            var is_Visible = button.data('is_Visible')
            var modal = $(this)
            modal.find('.modal-body #name').val(name);
            modal.find('.modal-body #title').val(title);
            modal.find('.modal-body #sub_title').val(sub_title);
